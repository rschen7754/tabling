...
<div id="bodydiv">
	...
	$query6 = "SELECT DATE_FORMAT(days.date, '%a, %b %e, %Y'), shifts.time, shifts.location FROM days, shifts, signups WHERE days.active='1' AND signups.shift = shifts.id AND signups.leader='$leaderid' AND shifts.day = days.id;";
