...
<div id="bodydiv">
	...
	?>
Please run credit to un-sign people up from the shift. Also consider sending a message letting them know tabling is cancelled.<br />
<form action="unshift2.php" method="post">
	Select the date: <br />
	
	
	<?php
	$query = "SELECT id, DATE_FORMAT(date, '%a, %b %e, %Y') FROM days;";
